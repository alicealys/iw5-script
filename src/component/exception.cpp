...
namespace exception
{
    namespace
    {
        ...
        void display_error_dialog()
        {
            ...
            show_mouse_cursor();
            MessageBoxA(nullptr, error_str.data(), "Plutonium IW5 ERROR", MB_ICONERROR);
        ...
        __declspec(naked) void get_reset_state_stub()
        {
            __asm
            {
                sub esp, 0x10
...
#pragma warning(pop)
        ...
        void write_minidump(const LPEXCEPTION_POINTERS exceptioninfo)
        {
            ...
            zip_file.write(crash_name, "Plutonium IW5 Crash Dump");
        }
        ...
        LONG WINAPI exception_filter(const LPEXCEPTION_POINTERS exceptioninfo)
        {
            ...
            exceptioninfo->ContextRecord->Eip = reinterpret_cast<uintptr_t>(&get_reset_state_stub);
